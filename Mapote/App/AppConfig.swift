...
enum AppConfigKey {
    ...
    static let aiChatEnabled = "app-config-ai-chat-enabled"
}
...
struct AppConfig {
    ...
    static func load() -> AppConfig {
        ...
        let aiChatEnabled = UserDefaults.standard.object(forKey: AppConfigKey.aiChatEnabled) == nil
            ? true
            : UserDefaults.standard.bool(forKey: AppConfigKey.aiChatEnabled)
        return AppConfig(
    ...
    func save() {
        ...
        UserDefaults.standard.set(aiChatEnabled, forKey: AppConfigKey.aiChatEnabled)
    }
}
